...
example = {
    "experience": "кілька місяців",
    "liked": "ну, нічого",
    "disliked": "воно не адекватне. воно робить знімок камерою, кидае його в галерею... і не може відкрити. сірий єкран. Реклама Тему буде з вами всюди, в вайбері, гугл пошті, і може ще десь))) про які 108 Мп вони шепчуть, проти самсунга це нокія \"кольорова",
    "comment": "краще, ніж нічого, но до самсунга як до неба рачки. як відключити Т9 так і не знайшов, як і багато інших функцій."
}
